...
% bug in the code here... Won't work if the signal length is not a perfect
% square. I guess this has only been tried on square images! Reshape is
% being called as reshape(<[sqrt(N), sqrt(N)] matrix>, N, 1)
