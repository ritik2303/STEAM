...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if (steamTpts(2)-steamTpts(1)>0)
        steam_vals_at_base_pts = spline_1d(steamTpts', steamVals(steamOpIndices,:)', ...
            baseTpts');
        bli_vals_at_base_pts = spline_1d(bliTpts', bliVals(bliOpIndices,:)', baseTpts');
    else
        steam_vals_at_base_pts = spline_1d(-steamTpts', steamVals(steamOpIndices,:)', ...
            -baseTpts');
        bli_vals_at_base_pts = spline_1d(-bliTpts', bliVals(bliOpIndices,:)', -baseTpts');
    ...
    if (nargout < 2)
        ...
        [figh, onames, colindex] = transientPlot(bli_dae, bliTpts, bliVals, ...
            bli_time_units, 'stateoutputs', bli_outs, 'lgndprefix', strcat('BLI-', ...
            method_bli.compression_factor, 'x'), 'linestyle', '-.', ...
