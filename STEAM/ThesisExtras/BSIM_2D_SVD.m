function [required_singular_values, reconstruction_error]  = BSIMsvd(...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    partial_reconstruction_error = zeros(MAX_SINGULAR_VALUES, 1);
    for n_singular_values = 1:MAX_SINGULAR_VALUES
        ...
        partial_reconstruction_error(n_singular_values,1) = find_error(...
    ...
    required_singular_values = find(partial_reconstruction_error < ...
        error_thresh, 1, 'first')/MAX_SINGULAR_VALUES;

    % Plotting reconstruction error
    if (doPlots)
        figure();
        plot_handle = stem(100*partial_reconstruction_error, 'linestyle', ...
